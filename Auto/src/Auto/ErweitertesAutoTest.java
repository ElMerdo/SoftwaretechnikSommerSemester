...
public class ErweitertesAutoTest {
	public static void main(String[] args) {
		...
		try {
			ErweitertesAuto pkw1 = new ErweitertesAuto("Hans2", "SUV", "Grün", 2010, 160, 80000, "Berlin", "S12U34V56");
			pkw1.meldung();
			...
			pkw1.SetzeNeuesZiel("München", 700);
		...
		ErweitertesAuto pkw3 = new ErweitertesAuto("Micha2", "Kleinwagen", "Grau", 2017, 70, -20, "Hamburg", "K12L34E56I78N90");
		try {
			pkw3.meldung();
